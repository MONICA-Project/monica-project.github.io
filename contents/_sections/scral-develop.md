...
This tutorial will help you to understand how to develop your own SCRAL module. If you want to understand how to run an already existent module, have a look to the [previous tutorial](https://monica-project.github.io/sections/scral-deploy.html).
...
To give to developers the possibility to quickly switch between different configuration, SCRAL can work using a configuration file or throuth environmental variables.
